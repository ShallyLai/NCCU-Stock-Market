...
export default function MyStockTable(props) {
    ...
    if (props.data.stock_name !== undefined) {
        ...
        for (var i = 0; i < props.data.stock_name.length; i++) {
            rows.push(createData(props.data.stock_id[i], props.data.stock_name[i], props.data.cur_price[i], props.data.stock_num[i]))
        }
        //   
    }
